...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 lg:m-2 md:my-0 md:mx-16 lg:mx-64 rounded-t-lg md:rounded-lg bg-darkBlueGradient text-dullBlue py-2.5 md:py-3 z-50 h-16">
