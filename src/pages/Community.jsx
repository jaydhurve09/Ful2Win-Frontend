  ...
  return (
    <div className="relative min-h-screen pb-24 overflow-hidden text-white bg-blueGradient">
      ...
      <div className="relative z-10">
        <Header />
        <div className="pt-16 md:pt-0 px-4 max-w-3xl mx-auto">
          {/* Tabs */}
          <div className="hidden md:flex gap-2 mb-4 overflow-x-auto py-2">
            {communityTabs.map((tab) => (
              <Button
                ...
                onClick={() => {
                  setActiveTab(tab.id);
                  if (tab.id === 'challenges') navigate('/challenges');
                  if (tab.id === 'chats') navigate('/chat');
                }}
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-6 border border-white/10">
            ...
            <div className="flex items-center mb-4">
              ...
              <input
                ...
                className="flex-1 bg-white/5 border border-white/10 rounded-full px-4 py-2 text-white placeholder-white-1100 focus:outline-none"
            ...
            {showCreatePost && (
              <div className="mt-4">
                <textarea
                  ...
                  className="w-full bg-white/10 border border-white/20 rounded-lg p-3 text-white placeholder-white/60 mb-3"
                  rows="3"
                  autoFocus
                />
