              ...
              <div className="flex md:hidden gap-2 mb-4 overflow-x-auto py-2">
                {communityTabs.map((tab) => (
                  ...
                  >
                    ...
                    {activeTab === tab.id && <span className="ml-1">{tab.label}</span>}
                  </Button>
                ))}
              </div>
            </div>
            ...
            <div className="w-full max-w-3xl px-4 mx-auto mt-1">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-6 border border-white/10">
                ...
                <div className="flex items-center justify-between border-t border-white/10 pt-3">
                  ...
                  <button className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-1.5 rounded-full text-sm font-medium" onClick={() => setShowCreatePost(true)}>Post</button>
                </div>
