...
const Tournaments = () => {
  ...
  const getFilteredTournaments = () => {
    return tournaments.filter(tournament => {
      ...
      const matchMode = tournament.mode === tournamentType;
              ...
              <div key={tournament.id} className="bg-gradient-to-br from-blue-900/30 to-blue-800/20 backdrop-blur-lg border border-blue-400/30 rounded-xl p-4 relative overflow-hidden">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <Button variant="primary" className="w-full bg-yellow-400 hover:bg-yellow-500 text-black font-semibold py-2 rounded-lg mb-2">
                      Join Tournament
                    </Button>
